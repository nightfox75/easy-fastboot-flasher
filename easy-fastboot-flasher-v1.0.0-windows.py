...
def on_button_clicked(filename):
    ...
    if checkbox_avb_remove.isChecked():
        os.system('cd '+resource_path("platform-tools")+' && fastboot --disable-verification --disable-verity flash vbmeta vbmeta.img')
    ...
    checkbox_avb_remove.setEnabled(True)
    app.processEvents()
